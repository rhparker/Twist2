...
\revised{
The choice of $N=6$ fibers is for efficiency of computation, and to parallel what was done in \cite{castro2016,parker2021}. Results for larger $N$ will be shown to illustrate the suppression effect in the opposite core when the twist parameter $\phi$ is $\pi/N$.
}
