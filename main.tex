...
\end{align}
The complex amplitudes $c_n$ are now functions of both $z$ and $t$. Letting $c = (c_1, \dots, c_n)^T$, we can write this in matrix form as
